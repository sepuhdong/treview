...
class Data_Guru(Tk): 
 ...
 # Membuat kursor 
    ...
    def tampilan_gui(self): 
        ...
        self.tree = ttk.Treeview(self, columns=("kode_guru", "nama_guru", "kelompok_guru", 
"mata_pelajaran"), show="headings") 
    ...
    def simpan_data(self): 
        ...
        query = "INSERT INTO guru (kode_guru, nama, kelompok_guru, mata_pelajaran) VALUES (%s, %s, %s, %s)" 
    ...
    def update_data(self): 
        ...
        self.mata_pelajaran_entry.insert("1.0", data[3]) 
...
self.proses_update(data[0])).grid(row=4, column=1, columnspan=2, pady=10) 
    ...
    def proses_update(self, nis_to_update): 
        ...
        query = "UPDATE guru SET kode_guru=%s, nama=%s, kelompok_guru=%s, mata_pelajaran=%s WHERE kode_guru=%s" 
